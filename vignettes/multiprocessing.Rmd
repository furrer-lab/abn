...
df <- FCV[, -c(13)]
#> Error in eval(expr, envir, enclos): object 'FCV' not found
...
res <- microbenchmark(mleSinglecore = buildScoreCache(data.df = df,
               ...
               bayesMulticoreFORK = buildScoreCache(data.df = df,
                                                    ...
                                                    control = build.control(method = "bayes",
                                                                            ...
                                                                            cluster.type = "FORK")),
               times = 25)
#> Error in buildScoreCache(data.df = df, data.dists = mydists, method = "bayes", : could not find function "buildScoreCache"
```
