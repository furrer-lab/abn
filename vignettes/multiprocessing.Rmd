...
print(paste("get system working directory: ", system("pwd")))
print(paste("list files in current working directory: ", system("ls -la ")))
print(paste("list files in parent directory: ", system("ls -la ../")))
print(paste("find all png files in the parent directory: ", system("find ../ -name '*.png'")))
```
