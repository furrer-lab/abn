test_that("Full output of the buildScoreCache.mle()", {
  # Data generated by buildScoreCache, just before calling buildScoreCache.mle()
  # Loaded "data/n_1000_p_16_nodedists_Balanced_s_02_graph1.Rdata" as input.
  params <- readRDS(file = "testdata/input_score_cache_mle.RData")
  out <- readRDS(file = "testdata/out_build_score_cache_mle.RData")
  # No group.var, binomial, gaussian, poisson, multinomial distributions, max.parents=3
  suppressMessages({
    suppressWarnings({
